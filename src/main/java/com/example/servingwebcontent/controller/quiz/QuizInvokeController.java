...
import com.example.servingwebcontent.service.quiz.impl.QuizInvokeServiceImpl;
...
public class QuizInvokeController {
	...
	private final QuizInvokeServiceImpl quizInvokeService;

	public QuizInvokeController(QuizInvokeServiceImpl quizInvokeService) {
